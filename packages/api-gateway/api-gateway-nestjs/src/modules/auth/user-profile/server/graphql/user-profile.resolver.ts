...
import { userProfileJoiSchema, IUser, IProfile } from '@gmahechas/common-nestjs';
...
} from '@api-gateway-nestjs/modules/auth/user-profile/server/graphql/user-profile.input';
