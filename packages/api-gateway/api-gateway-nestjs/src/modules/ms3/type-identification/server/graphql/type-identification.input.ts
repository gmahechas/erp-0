...
@InputType()
export class TypeIdentificationCreateInput
  implements Partial<ITypeIdentification> {
  @Field() typeIdentificationDescription: string;
  @Field() typeIdentificationCode: string;
}

@InputType()
export class TypeIdentificationSearchInput
  implements Partial<ITypeIdentification> {
...
@InputType()
export class TypeIdentificationUpdateInput
  implements Partial<ITypeIdentification> {
  @Field() id: string;
  @Field({ nullable: true }) typeIdentificationDescription: string;
  @Field({ nullable: true }) typeIdentificationCode: string;
...
@InputType()
export class TypeIdentificationDeleteInput
  implements Partial<ITypeIdentification> {
  @Field() id: string;
}
